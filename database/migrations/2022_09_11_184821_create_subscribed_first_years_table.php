...
class CreateSubscribedFirstYearsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('subscribed_first_years', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('subscribed_first_years');
    }
}
