...
<header class="header">
    ...
    <section class="courses">
        <h2 class="main-title">الصف الثاني الثانوي</h2>
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <div class="thumb">
                    <img src="{{asset('images/thumb-6.png')}}">
                    <span>10 videos</span>
                </div>
                <h3 class="title">كورس الشهر الأول 2ث</h3>
                <div class="box-links">
            ...
            <div class="box">
                ...
                <h3 class="title">كورس الشهر الثاني 2ث</h3>
                <div class="box-links">
                    <a href="playlist.html" class="inline-btn">الدخول للكورس</a>
                    <a href="playlist.html" class="inline-btn">اشترك الآن !</a>
                </div>
            ...
            <div class="box">
                ...
                <h3 class="title">كورس الشهر الثالث 2ث</h3>
                <div class="box-links">
                    <a href="playlist.html" class="inline-btn">الدخول للكورس</a>
                    <a href="playlist.html" class="inline-btn">اشترك الآن !</a>
                </div>
