            ...
            <div class="dropdown-container">
                @foreach($course['lectures'] as $key => $lec)
                    @if( $lec->week == 1)
                        ...
                        <a href="{{route('view.quiz.link.1st',$week1[$key]->id)}}">
            ...
            <div class="dropdown-container">
                @foreach($course['lectures'] as $key => $lec)
                    @if( $lec->week == 2)
                        ...
                        <a href="{{route('view.quiz.link.1st',$week2[$key]->id)}}">
                            <i class="fa-solid fa-chalkboard-user"></i>
                            <span> كويز : {{$lec->name}}</span></a>
            ...
            <div class="dropdown-container">
                @foreach($course['lectures'] as $key => $lec)
                    @if( $lec->week == 3)
                        ...
                        <a href="{{route('view.quiz.link.1st',$week3[$key]->id)}}">
                            <i class="fa-solid fa-chalkboard-user"></i>
                            <span> كويز : {{$lec->name}}</span></a>
...
{{--                            <span>حل واجب : {{$lec->name}}</span></a>--}}
                        <a href="{{route('view.quiz.link.1st',$week4[$key]->id)}}">
                            <i class="fa-solid fa-chalkboard-user"></i>
                            <span> كويز : {{$lec->name}}</span></a>
